...
inline String LookupString(const rapidjson::Value& v, const Char* field, bool& out_error)
{
	(void)out_error;
	return (String)(v.IsObject() && v[field].IsString() ? v[field].GetString() : (""));
}
...
inline bool HasField(const rapidjson::Value& v, const Char* field, bool& out_error)
{
	(void)out_error;
	return v.IsObject() && v.HasMember(field);
}
inline bool HasArrayField(const rapidjson::Value& v, const Char* field, bool& out_error)
{
	(void)out_error;
	return v.IsObject() && v[field].IsArray();
}
...
inline String AsString(const rapidjson::Value& v, bool& out_error)
{
	(void)out_error;
...
inline bool IsObject(const rapidjson::Value& v, bool& out_error)
{
	(void)out_error;
	return v.IsObject();
}
...
inline void AddString(Builder& b, const Char* key, const Char* value)
{
	b.w.String(key);
	b.w.String(value);
}
...
void AddValues(Builder& b, T arg0, Args... args)
{
	AddValues(b, arg0);
	AddValues(b, args...);
}
template<class... Args>
void AddArray(Builder& b, const Char* key, Args... args)
{
	b.w.String(key);
	b.w.StartArray();
	AddValues(b, args...);
